...
def train(
    ...
    for epoch in range(epochs):
        ...
        for batch in range(batch_num):
            ...
            pre, _ = sess.run(
                [model.viterbi_sequence, model.train_op], feed_dict)
            acc = 0
